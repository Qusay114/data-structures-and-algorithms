...
const extractAbilities = (arr) => {
  const abilityNames = arr.abilities.map(abObject =>{
    return abObject.ability.name ;
  });
  return abilityNames ;
};
...
const extractStats = (arr) => {
  const stats = arr.stats.map(statObject =>{
